...
//   Desktop (lg+) : photo visible a gauche, fondu creme vers la droite ou se trouve le texte.
    ...
    <section className="relative isolate overflow-hidden bg-[#FDFAF6] py-16 sm:py-20 lg:py-28">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{ background: `linear-gradient(to left, ${CREAM} 0%, ${CREAM} 38%, ${CREAM}CC 55%, ${CREAM}40 78%, ${CREAM}0D 100%)` }}
        />
      </div>
